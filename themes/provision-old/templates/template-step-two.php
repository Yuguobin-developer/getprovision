...
if(isset($_GET['k']) && !empty($_GET['k'])){
    ...
    if(isset($output['zipcode']) && !empty($output['zipcode'])){
        ...
        if (isset($output['utility']) && !empty($output['utility'])) {
            ...
            $hideUtility = true;
            if(isset($_GET['show']) && ($_GET['show'] == 'plans') ) { $showplans = true; }
        }
...
//        print_r($utilityIds);
    ...
    if(isset($_GET['show']) && $_GET['show'] == 'notification'){ $hideUtility = true; $showplans = false; }
    elseif(isset($_GET['show']) && ($_GET['show']) == 'plans' ){ $hideUtility = true; $showplans = true; }
    if(isset($_GET['plan'])){
        $planSelected = explode(',',$_GET['plan']);
    }
}else{
...
if(($hideUtility && !$showplans) || ($_GET['hideutility'] == 'notification') ){
...
//                print_pre($utilitiesArr);
            ...
            <li class="accordion-item accordion-notification second-step">
                <a class="toggle single-plans accordion-trigger  <?php if($hideUtility && !$showplans) echo 'accordion-open'; ?>" href="javascript:void(0)">
                ...
                <div class="inner single-plans accordion-collapse"<?php if($hideUtility && !$showplans){ echo 'style="display: block;"'; } ?> >
                    ...
                    <li class="accordion-item accordion-plans center-align third-step">
                        <a class="toggle single-plans accordion-trigger accordion-plans choose-plan-module <?php if($hideUtility && $showplans) echo 'accordion-open'; ?>" href="javascript:void(0)">
                            <h4 class="center-align">Choose your plan</h4>
                        </a>
                        
                        <div class="inner single-plans steps-address-container accordion-collapse" <?php if($hideUtility && $showplans){ echo 'style="display: block;"'; } ?>>
                            <form id="plan_form">
                            ...
                            <?php
                             ...
                             foreach ($utilityIds as $utility){
                                ...
                                <!-- /.join-two-plans -->
                                    ...
                                    <h2>Choose your <?php echo strtolower($typ); ?> plan </h2>
                                            ...
                                            <div class="single-step-widget <?php echo $class; ?>">
                                                ...
                                                <div class="widget <?php if(in_array($planId,$planSelected)){ echo 'selected'; } ?>">
                                                    <div class="step-widget-inner">
                                                        ...
                                                        if($carbonBetter){
                                                            echo '<h5 class="trade-mark"> Carbon Better&#8482; </h5>';
                                                        }else{
