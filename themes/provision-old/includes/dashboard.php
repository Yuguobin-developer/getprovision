		...
		<div class="welcome-panel-column-container">
			<div class="welcome-panel-container">
				<div class="welcome-panel-column-half">
					...
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque asperiores consequatur commodi maiores
						molestiae nihil, nostrum saepe, cupiditate corrupti quibusdam eveniet, minima optio consequuntur quidem?
					</p>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe itaque placeat maiores quam deserunt.
						Voluptates ad at deserunt quam error nulla ut incidunt, dolores facere.</p>
					<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam, qui ex. Nisi possimus velit, corporis
						maxime dolorem itaque, sequi praesentium magnam soluta ducimus repudiandae illum?</p>
					...
					<div class="cdw-form-container">
						<form name="contactform" method="post" action="http://sample.abubakar.me/wp-content/send_form_email.php">
							<div class="cdw-form-input cdw-half-input-field">
								<input type="text" name="first_name" id="first_name" maxlength="50" class="cdw-single-input"
			...
			<div class="cdw-container-heading"> Our Services </div>
			<div class="welcome-panel-container services-container">
				<div class="welcome-panel-column-fourth">
					<div class="cdw-service-panel">
						...
						<div class="cdw-service-heading"> WordPress Development </div>
					</div>
			...
			<div class="welcome-panel-column">
				...
				<a class="button button-primary button-hero load-customize hide-if-no-customize"
					href="http://localhost:8888/uw-website/wp-admin/customize.php">Customize Your Site</a>
				<a class="button button-primary button-hero hide-if-customize"
					href="http://localhost:8888/uw-website/wp-admin/themes.php">Customize Your Site</a>
				<p class="hide-if-no-customize">or, <a href="http://localhost:8888/uw-website/wp-admin/themes.php">change your
						theme completely</a></p>
			</div><!-- .welcome-panel-column -->
			<div class="welcome-panel-column">
				<h3>Next Steps</h3>
				<ul>
					<li><a href="http://localhost:8888/uw-website/wp-admin/post.php?post=2557&amp;action=edit"
							class="welcome-icon welcome-edit-page">Edit your front page</a></li>
					<li><a href="http://localhost:8888/uw-website/wp-admin/post-new.php?post_type=page"
							class="welcome-icon welcome-add-page">Add additional pages</a></li>
					<li><a href="http://localhost:8888/uw-website/wp-admin/post-new.php"
							class="welcome-icon welcome-write-blog">Add a blog post</a></li>
			...
			<div class="welcome-panel-column welcome-panel-last">
				...
				<ul>
					<li>
						<div class="welcome-icon welcome-widgets-menus">Manage <a
								href="http://localhost:8888/uw-website/wp-admin/widgets.php">widgets</a> or <a
								href="http://localhost:8888/uw-website/wp-admin/nav-menus.php">menus</a></div>
					</li>
					<li><a href="http://localhost:8888/uw-website/wp-admin/options-discussion.php"
