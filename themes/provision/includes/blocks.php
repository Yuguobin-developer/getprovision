			...
			array(
				...
				'keywords'        => array( 'icons', 'numbers' ),
                                'enqueue_assets' => function(){
                                    wp_enqueue_script( 'block-enerygy-cta-1', get_template_directory_uri() . '/assets/js/noframework.waypoints.min.js', array('jquery'));
                                    wp_enqueue_script( 'block-enerygy-cta-2', get_template_directory_uri() . '/assets/js/lottie.min.js', array('jquery','block-enerygy-cta-1'));
                                    wp_enqueue_script( 'block-enerygy-cta-3', get_template_directory_uri() . '/assets/lottie-animation.js', array('block-enerygy-cta-2'));
                                    },
                        )
                );
