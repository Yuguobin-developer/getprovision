			...
			<div class="big-wrapper">
				<div class="left-header">
					<div class="logo">
						...
						<!--<a href="<?php echo home_url(  ); ?>"><img src="/wp-content/uploads/2022/01/provision-energy-for-good-tm.svg" alt="Site Logo"></a>-->
						<!--<a href="<?= home_url(  ); ?>"><img src="/wp-content/uploads/2022/06/provision-power-and-gas-header.svg" alt="Site Logo"></a>-->
						<!--<a href="<?= home_url(  ); ?>"><img src="/wp-content/uploads/2022/06/provision-logo-power-and-gas-header.svg" alt="Provision Power and Gas"></a>-->
						<!--<a href="<?= home_url(  ); ?>"><img src="<?= get_template_directory_uri(); ?>/assets/img/Provision-Logo-Power_and_Gas-Header.svg" alt="Provision Power and Gas"></a>-->
					<a href="<?= home_url(  ); ?>"><img src="<?= get_template_directory_uri(); ?>/assets/img/provision-power-and-gas-header.svg" alt="Provision Power and Gas"></a>
					</div>
		...
		<div class="big-wrapper">
			<div class="left-header">
				<div class="logo">
					...
					<!--<a href="<?php echo home_url(  ); ?>"><img src="/wp-content/uploads/2022/01/provision-energy-for-good-tm.svg" alt="Site Logo"></a>-->
					<!--<a href="<?= home_url(  ); ?>"><img src="/wp-content/uploads/2022/06/provision-power-and-gas-header.svg" alt="Site Logo"></a>-->
					<!--<a href="<?= home_url(  ); ?>"><img src="/wp-content/uploads/2022/06/provision-logo-power-and-gas-header.svg" alt="Provision Power & Gas"></a>-->
					<!--<a href="<?= home_url(  ); ?>"><img src="<?= get_template_directory_uri(); ?>/assets/img/Provision-Logo-Power_and_Gas-Header.svg" alt="Provision Power and Gas"></a>-->
					<a href="<?= home_url(  ); ?>"><img src="<?= get_template_directory_uri(); ?>/assets/img/provision-power-and-gas-header.svg" alt="Provision Power and Gas"></a>
				</div>
				<div class="mobile-logo">
					<!--<img src="<?= get_template_directory_uri(); ?>/assets/img/header-white-logo.svg" alt="Site Logo">-->
					<!--<img src="/wp-content/uploads/2022/01/provision-footer-logo.svg" alt="Site Logo">-->
					<img src="<?= get_template_directory_uri(); ?>/assets/img/Provision-Logo-Power_and_Gas-Footer-transparent.svg" alt="Provision Power and Gas">
					<!--<img src="<?= get_template_directory_uri(); ?>/assets/img/provision-logo-power-and-gas-footer.svg" alt="Provision Power and Gas">-->
				</div>
				<div class="login-icon desktop-hide" target="_blank"><img src="<?php echo $pwrvsn_header_co_icon; ?>" alt="">
				</div>
				<div class="contact-dropdown m-contact-dropdown">
