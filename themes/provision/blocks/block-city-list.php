...
if($blok_cl_city_list_type=='automatic') {
	...
	$cityquery = "SELECT city, state FROM wp_utility_post_data WHERE state = '".$blok_cl_city_state."' GROUP BY zipcode ORDER BY zipcode ASC LIMIT 0, ".$blok_cl_display_limit;
