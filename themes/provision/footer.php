                            ...
                            <div class="contact-dropdown-">
                                ...
                                <div class="header-contact-container">
                                        <div class="header-contact">
                                                ...
                                                <a href="tel:<?php echo preg_replace( '/[^0-9]/', '', $pwrvsn_header_co_phone_phone ); ?>">
                                                        <span class="contact-icon">
                                                                <img src="<?php echo $pwrvsn_header_co_phone_icon; ?>" width="62" height="42" alt="Call Us">
                                                        </span>
                                                        <span>
                                        ...
                                        <div class="header-contact">
												...
												<?php } ?>
                                                        <span class="contact-icon">
                                                                <img src="<?php echo $pwrvsn_header_co_chat_icon; ?>" width="46" height="46" alt="Chat With Us">
                                                        </span>
                                                        <span>
                                        ...
                                        <div class="header-contact">
                                            ...
                                            <a target="_blank" href="<?php echo $pwrvsn_header_co_email_linkurl; ?>">
                                                        <span class="contact-icon">
                                                                <img src="<?php echo $pwrvsn_header_co_email_icon; ?>" width="46" height="46" alt="Email Us">
                                                        </span>
                                                        <span>
				...
				<div class="footer-top-left">
					<div class="footer-logo">
                                            <a href="<?php echo home_url(); ?>">
                                                <!--<img src="<?php echo get_template_directory_uri(); ?>/assets/img/footer-logo.svg" alt="Energy For Good">-->
                                                <img src="<?= get_template_directory_uri(); ?>/assets/img/Provision-Logo-Power_and_Gas-Footer-transparent.svg" width="400" height="95" alt="Provision Power and Gas">
                                                <!--<img src="<?= get_template_directory_uri(); ?>/assets/img/provision-logo-power-and-gas-footer.svg" alt="Provision Power & Gas">-->
                                            </a>
					</div>
					<?php if($prvsn_to_ftr_headline){ ?>
						<h4><?= trim($prvsn_to_ftr_headline); ?>&reg;</h4>
					<?php } ?>
				</div>
				<div class="footer-top-right">
					<div class="footer-carbon-better-badge">
                                            <a href="https://carbonbetter.com/case-study/provision/" target="_blank">
                                                 <img src="/wp-content/uploads/2021/12/CARB001_Primary_Badge_RGB_CERTIFIED_SoftBlack-01.png" width="567" height="204" alt="CarbonBetter Primary Badge - Soft Black">
                                            </a>
                                        </div>
					<div class="footer-socials">
						<?php if($prvsn_to_ftr_social_links_insta){ ?>
							<a href="<?php echo $prvsn_to_ftr_social_links_insta; ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/instagram-icon.svg" width="20" height="20" alt="Instagram"></a>
						<?php } ?>
						<?php if($prvsn_to_ftr_social_links_fb){ ?>
							<a href="<?php echo $prvsn_to_ftr_social_links_fb; ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/facebook-icon.svg" width="10" height="20" alt="Facebook"></a>
						<?php } ?>
						<?php if($prvsn_to_ftr_social_links_tw){ ?>
							<a href="<?php echo $prvsn_to_ftr_social_links_tw; ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/twitter-icon.svg" width="19" height="16" alt="Twitter"></a>
						<?php } ?>
					</div>
				</div>
				<div class="clear"></div>
			...
			<div class="widgets-container">
				<div class="footer-widget contact-widget">
					...
					<?php if($prvsn_to_ftr_communicationmethods_email){ ?>
						<a href="<?php echo $prvsn_to_ftr_communicationmethods_email_link; ?>" class="footer-email"><?php echo $email_text_main; ?></a>
					<?php } ?>
				</div>
			...
			<div class="footer-bottom">
				...
				<div class="footer-logos">
					<?php if($prvsn_to_ftr_logos1){ ?>
						<span class="f-b-logo"><img src="<?php echo $prvsn_to_ftr_logos1; ?>" width="80" height="32" alt="MPSC Logo"></span>
					<?php } ?>
					<?php if($prvsn_to_ftr_logos2){ ?>
						<span class="f-b-logo"><img src="<?php echo $prvsn_to_ftr_logos2; ?>" width="157" height="52" alt="Ohio Logo"></span>
					<?php } ?>
				</div>
				<div class="clear"></div>
			</div>
