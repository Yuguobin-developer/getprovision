 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_Taskqueue extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->taskqueues = new SmartSEO_Google_Service_Taskqueue_Taskqueues_Resource(
        $this,
        $this->serviceName,
        'taskqueues',
        array(
    ...
    $this->tasks = new SmartSEO_Google_Service_Taskqueue_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $taskqueueService = new SmartSEO_Google_Service_Taskqueue(...);
 *   $taskqueues = $taskqueueService->taskqueues;
 *  </code>
 */
class SmartSEO_Google_Service_Taskqueue_Taskqueues_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @return SmartSEO_Google_Service_Taskqueue_TaskQueue
   */
  public function get($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SmartSEO_Google_Service_Taskqueue_TaskQueue");
  }
}
 ...
 *  </code>
 */
class SmartSEO_Google_Service_Taskqueue_Tasks_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_Taskqueue_Task
   */
  public function get($project, $taskqueue, $task, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SmartSEO_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return SmartSEO_Google_Service_Taskqueue_Task
   */
  public function insert($project, $taskqueue, SmartSEO_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "SmartSEO_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return SmartSEO_Google_Service_Taskqueue_Tasks
   */
  public function lease($project, $taskqueue, $numTasks, $leaseSecs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lease', array($params), "SmartSEO_Google_Service_Taskqueue_Tasks");
  }
  /**
   ...
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_Taskqueue_Tasks2
   */
  public function listTasks($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SmartSEO_Google_Service_Taskqueue_Tasks2");
  }
  /**
   ...
   * @return SmartSEO_Google_Service_Taskqueue_Task
   */
  public function patch($project, $taskqueue, $task, $newLeaseSeconds, SmartSEO_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "SmartSEO_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return SmartSEO_Google_Service_Taskqueue_Task
   */
  public function update($project, $taskqueue, $task, $newLeaseSeconds, SmartSEO_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "SmartSEO_Google_Service_Taskqueue_Task");
  }
}
...
class SmartSEO_Google_Service_Taskqueue_Task extends SmartSEO_Google_Model
{
...
class SmartSEO_Google_Service_Taskqueue_TaskQueue extends SmartSEO_Google_Model
{
  protected $aclType = 'SmartSEO_Google_Service_Taskqueue_TaskQueueAcl';
  protected $aclDataType = '';
  public $id;
  public $kind;
  public $maxLeases;
  protected $statsType = 'SmartSEO_Google_Service_Taskqueue_TaskQueueStats';
  protected $statsDataType = '';

  public function setAcl(SmartSEO_Google_Service_Taskqueue_TaskQueueAcl $acl)
  {
    $this->acl = $acl;
  }
  ...
  public function setStats(SmartSEO_Google_Service_Taskqueue_TaskQueueStats $stats)
  {
    $this->stats = $stats;
  }
...
class SmartSEO_Google_Service_Taskqueue_TaskQueueAcl extends SmartSEO_Google_Collection
{
  public $adminEmails;
...
class SmartSEO_Google_Service_Taskqueue_TaskQueueStats extends SmartSEO_Google_Model
{
...
class SmartSEO_Google_Service_Taskqueue_Tasks extends SmartSEO_Google_Collection
{
  protected $itemsType = 'SmartSEO_Google_Service_Taskqueue_Task';
...
class SmartSEO_Google_Service_Taskqueue_Tasks2 extends SmartSEO_Google_Collection
{
  protected $itemsType = 'SmartSEO_Google_Service_Taskqueue_Task';
  protected $itemsDataType = 'array';
  public $kind;
