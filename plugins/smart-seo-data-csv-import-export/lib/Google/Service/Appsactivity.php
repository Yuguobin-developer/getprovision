 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_Appsactivity extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->activities = new SmartSEO_Google_Service_Appsactivity_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appsactivityService = new SmartSEO_Google_Service_Appsactivity(...);
 *   $activities = $appsactivityService->activities;
 *  </code>
 */
class SmartSEO_Google_Service_Appsactivity_Activities_Resource extends SmartSEO_Google_Service_Resource
{
  ...
  -
    * drive.google.com
   * @return SmartSEO_Google_Service_Appsactivity_ListActivitiesResponse
   */
  public function listActivities($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SmartSEO_Google_Service_Appsactivity_ListActivitiesResponse");
  }
}
...
class SmartSEO_Google_Service_Appsactivity_Activity extends SmartSEO_Google_Collection
{
  protected $combinedEventType = 'SmartSEO_Google_Service_Appsactivity_Event';
  protected $combinedEventDataType = '';
  protected $singleEventsType = 'SmartSEO_Google_Service_Appsactivity_Event';
  protected $singleEventsDataType = 'array';

  public function setCombinedEvent(SmartSEO_Google_Service_Appsactivity_Event $combinedEvent)
  {
...
class SmartSEO_Google_Service_Appsactivity_Event extends SmartSEO_Google_Collection
{
  public $additionalEventTypes;
  public $eventTimeMillis;
  public $fromUserDeletion;
  protected $moveType = 'SmartSEO_Google_Service_Appsactivity_Move';
  protected $moveDataType = '';
  protected $permissionChangesType = 'SmartSEO_Google_Service_Appsactivity_PermissionChange';
  protected $permissionChangesDataType = 'array';
  public $primaryEventType;
  protected $renameType = 'SmartSEO_Google_Service_Appsactivity_Rename';
  protected $renameDataType = '';
  protected $targetType = 'SmartSEO_Google_Service_Appsactivity_Target';
  protected $targetDataType = '';
  protected $userType = 'SmartSEO_Google_Service_Appsactivity_User';
  ...
  public function setMove(SmartSEO_Google_Service_Appsactivity_Move $move)
  {
    $this->move = $move;
  }
  ...
  public function setRename(SmartSEO_Google_Service_Appsactivity_Rename $rename)
  {
    $this->rename = $rename;
  }
  ...
  public function setTarget(SmartSEO_Google_Service_Appsactivity_Target $target)
  {
    $this->target = $target;
  }
  ...
  public function setUser(SmartSEO_Google_Service_Appsactivity_User $user)
  {
    $this->user = $user;
  }
...
class SmartSEO_Google_Service_Appsactivity_ListActivitiesResponse extends SmartSEO_Google_Collection
{
  protected $activitiesType = 'SmartSEO_Google_Service_Appsactivity_Activity';
...
class SmartSEO_Google_Service_Appsactivity_Move extends SmartSEO_Google_Collection
{
  protected $addedParentsType = 'SmartSEO_Google_Service_Appsactivity_Parent';
  protected $addedParentsDataType = 'array';
  protected $removedParentsType = 'SmartSEO_Google_Service_Appsactivity_Parent';
...
class SmartSEO_Google_Service_Appsactivity_Parent extends SmartSEO_Google_Model
{
  public $id;
  public $isRoot;
  public $title;
...
class SmartSEO_Google_Service_Appsactivity_Permission extends SmartSEO_Google_Model
{
  public $name;
  public $permissionId;
  public $role;
...
class SmartSEO_Google_Service_Appsactivity_PermissionChange extends SmartSEO_Google_Collection
{
  protected $addedPermissionsType = 'SmartSEO_Google_Service_Appsactivity_Permission';
  protected $addedPermissionsDataType = 'array';
  protected $removedPermissionsType = 'SmartSEO_Google_Service_Appsactivity_Permission';
...
class SmartSEO_Google_Service_Appsactivity_Photo extends SmartSEO_Google_Model
{
  public $url;
...
class SmartSEO_Google_Service_Appsactivity_Rename extends SmartSEO_Google_Model
{
  public $newTitle;
  public $oldTitle;
...
class SmartSEO_Google_Service_Appsactivity_Target extends SmartSEO_Google_Model
{
  public $id;
  public $mimeType;
  public $name;
...
class SmartSEO_Google_Service_Appsactivity_User extends SmartSEO_Google_Model
{
  public $name;
  protected $photoType = 'SmartSEO_Google_Service_Appsactivity_Photo';
  ...
  public function setPhoto(SmartSEO_Google_Service_Appsactivity_Photo $photo)
  {
    $this->photo = $photo;
  }
