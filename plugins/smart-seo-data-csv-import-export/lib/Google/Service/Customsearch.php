 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_Customsearch extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->cse = new SmartSEO_Google_Service_Customsearch_Cse_Resource(
        $this,
        $this->serviceName,
        'cse',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $customsearchService = new SmartSEO_Google_Service_Customsearch(...);
 *   $cse = $customsearchService->cse;
 *  </code>
 */
class SmartSEO_Google_Service_Customsearch_Cse_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * Controls whether to include or exclude results from the site named in the as_sitesearch
    * parameter
   * @return SmartSEO_Google_Service_Customsearch_Search
   */
  public function listCse($q, $optParams = array())
  {
    $params = array('q' => $q);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SmartSEO_Google_Service_Customsearch_Search");
  }
}
...
class SmartSEO_Google_Service_Customsearch_Context extends SmartSEO_Google_Collection
{
  protected $facetsType = 'SmartSEO_Google_Service_Customsearch_ContextFacets';
...
class SmartSEO_Google_Service_Customsearch_ContextFacets extends SmartSEO_Google_Model
{
  public $anchor;
  public $label;
  public $labelWithOp;
...
class SmartSEO_Google_Service_Customsearch_Promotion extends SmartSEO_Google_Collection
{
  protected $bodyLinesType = 'SmartSEO_Google_Service_Customsearch_PromotionBodyLines';
  protected $bodyLinesDataType = 'array';
  public $displayLink;
  public $htmlTitle;
  protected $imageType = 'SmartSEO_Google_Service_Customsearch_PromotionImage';
  ...
  public function setImage(SmartSEO_Google_Service_Customsearch_PromotionImage $image)
  {
    $this->image = $image;
  }
...
class SmartSEO_Google_Service_Customsearch_PromotionBodyLines extends SmartSEO_Google_Model
{
  public $htmlTitle;
  public $link;
  public $title;
...
class SmartSEO_Google_Service_Customsearch_PromotionImage extends SmartSEO_Google_Model
{
  public $height;
  public $source;
  public $width;
...
class SmartSEO_Google_Service_Customsearch_Query extends SmartSEO_Google_Model
{
  public $count;
  public $cr;
  public $cref;
...
class SmartSEO_Google_Service_Customsearch_Result extends SmartSEO_Google_Collection
{
  public $cacheId;
  public $displayLink;
  public $fileFormat;
  ...
  public $htmlSnippet;
  public $htmlTitle;
  protected $imageType = 'SmartSEO_Google_Service_Customsearch_ResultImage';
  protected $imageDataType = '';
  public $kind;
  protected $labelsType = 'SmartSEO_Google_Service_Customsearch_ResultLabels';
  ...
  public function setImage(SmartSEO_Google_Service_Customsearch_ResultImage $image)
  {
    $this->image = $image;
  }
...
class SmartSEO_Google_Service_Customsearch_ResultImage extends SmartSEO_Google_Model
{
  public $byteSize;
  public $contextLink;
  public $height;
...
class SmartSEO_Google_Service_Customsearch_ResultLabels extends SmartSEO_Google_Model
{
  public $displayName;
  public $labelWithOp;
  public $name;
...
class SmartSEO_Google_Service_Customsearch_ResultPagemap extends SmartSEO_Google_Model
{

}

class SmartSEO_Google_Service_Customsearch_ResultPagemapItemElement extends SmartSEO_Google_Model
{

}

class SmartSEO_Google_Service_Customsearch_Search extends SmartSEO_Google_Collection
{
  protected $contextType = 'SmartSEO_Google_Service_Customsearch_Context';
  protected $contextDataType = '';
  protected $itemsType = 'SmartSEO_Google_Service_Customsearch_Result';
  protected $itemsDataType = 'array';
  public $kind;
  protected $promotionsType = 'SmartSEO_Google_Service_Customsearch_Promotion';
  protected $promotionsDataType = 'array';
  protected $queriesType = 'SmartSEO_Google_Service_Customsearch_Query';
  protected $queriesDataType = 'map';
  protected $searchInformationType = 'SmartSEO_Google_Service_Customsearch_SearchSearchInformation';
  protected $searchInformationDataType = '';
  protected $spellingType = 'SmartSEO_Google_Service_Customsearch_SearchSpelling';
  protected $spellingDataType = '';
  protected $urlType = 'SmartSEO_Google_Service_Customsearch_SearchUrl';
  protected $urlDataType = '';

  public function setContext(SmartSEO_Google_Service_Customsearch_Context $context)
  {
  ...
  public function setSearchInformation(SmartSEO_Google_Service_Customsearch_SearchSearchInformation $searchInformation)
  {
  ...
  public function setSpelling(SmartSEO_Google_Service_Customsearch_SearchSpelling $spelling)
  {
  ...
  public function setUrl(SmartSEO_Google_Service_Customsearch_SearchUrl $url)
  {
    $this->url = $url;
  }
...
class SmartSEO_Google_Service_Customsearch_SearchQueries extends SmartSEO_Google_Model
{

}

class SmartSEO_Google_Service_Customsearch_SearchSearchInformation extends SmartSEO_Google_Model
{
...
class SmartSEO_Google_Service_Customsearch_SearchSpelling extends SmartSEO_Google_Model
{
...
class SmartSEO_Google_Service_Customsearch_SearchUrl extends SmartSEO_Google_Model
{
  public $template;
  public $type;
