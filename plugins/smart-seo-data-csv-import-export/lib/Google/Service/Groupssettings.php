 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_Groupssettings extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->groups = new SmartSEO_Google_Service_Groupssettings_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $groupssettingsService = new SmartSEO_Google_Service_Groupssettings(...);
 *   $groups = $groupssettingsService->groups;
 *  </code>
 */
class SmartSEO_Google_Service_Groupssettings_Groups_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @return SmartSEO_Google_Service_Groupssettings_Groups
   */
  public function get($groupUniqueId, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SmartSEO_Google_Service_Groupssettings_Groups");
  }
  /**
   ...
   * @param string $groupUniqueId
   * The resource ID
   * @param SmartSEO_Google_Groups $postBody
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_Groupssettings_Groups
   */
  public function patch($groupUniqueId, SmartSEO_Google_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "SmartSEO_Google_Service_Groupssettings_Groups");
  }
  /**
   ...
   * @return SmartSEO_Google_Service_Groupssettings_Groups
   */
  public function update($groupUniqueId, SmartSEO_Google_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "SmartSEO_Google_Service_Groupssettings_Groups");
  }
}
...
class SmartSEO_Google_Service_Groupssettings_Groups extends SmartSEO_Google_Model
{
