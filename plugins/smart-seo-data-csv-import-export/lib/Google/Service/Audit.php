 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_Audit extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->activities = new SmartSEO_Google_Service_Audit_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $auditService = new SmartSEO_Google_Service_Audit(...);
 *   $activities = $auditService->activities;
 *  </code>
 */
class SmartSEO_Google_Service_Audit_Activities_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * Next page URL.
   * @return SmartSEO_Google_Service_Audit_Activities
   */
  public function listActivities($customerId, $applicationId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "SmartSEO_Google_Service_Audit_Activities");
  }
}
...
class SmartSEO_Google_Service_Audit_Activities extends SmartSEO_Google_Collection
{
  protected $itemsType = 'SmartSEO_Google_Service_Audit_Activity';
...
class SmartSEO_Google_Service_Audit_Activity extends SmartSEO_Google_Collection
{
  protected $actorType = 'SmartSEO_Google_Service_Audit_ActivityActor';
  protected $actorDataType = '';
  protected $eventsType = 'SmartSEO_Google_Service_Audit_ActivityEvents';
  protected $eventsDataType = 'array';
  protected $idType = 'SmartSEO_Google_Service_Audit_ActivityId';
  protected $idDataType = '';
  public $ipAddress;
  public $kind;
  public $ownerDomain;

  public function setActor(SmartSEO_Google_Service_Audit_ActivityActor $actor)
  {
    $this->actor = $actor;
  }
  ...
  public function setId(SmartSEO_Google_Service_Audit_ActivityId $id)
  {
    $this->id = $id;
  }
...
class SmartSEO_Google_Service_Audit_ActivityActor extends SmartSEO_Google_Model
{
...
class SmartSEO_Google_Service_Audit_ActivityEvents extends SmartSEO_Google_Collection
{
  public $eventType;
  public $name;
  protected $parametersType = 'SmartSEO_Google_Service_Audit_ActivityEventsParameters';
...
class SmartSEO_Google_Service_Audit_ActivityEventsParameters extends SmartSEO_Google_Model
{
  public $name;
  public $value;
...
class SmartSEO_Google_Service_Audit_ActivityId extends SmartSEO_Google_Model
{
  public $applicationId;
  public $customerId;
  public $time;
