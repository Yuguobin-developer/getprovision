 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_Dns extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->changes = new SmartSEO_Google_Service_Dns_Changes_Resource(
        $this,
        $this->serviceName,
        'changes',
        array(
    ...
    $this->managedZones = new SmartSEO_Google_Service_Dns_ManagedZones_Resource(
        $this,
        $this->serviceName,
        'managedZones',
        array(
    ...
    $this->projects = new SmartSEO_Google_Service_Dns_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->resourceRecordSets = new SmartSEO_Google_Service_Dns_ResourceRecordSets_Resource(
        $this,
        $this->serviceName,
        'resourceRecordSets',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $dnsService = new SmartSEO_Google_Service_Dns(...);
 *   $changes = $dnsService->changes;
 *  </code>
 */
class SmartSEO_Google_Service_Dns_Changes_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @param SmartSEO_Google_Change $postBody
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_Dns_Change
   */
  public function create($project, $managedZone, SmartSEO_Google_Service_Dns_Change $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "SmartSEO_Google_Service_Dns_Change");
  }
  /**
  ...
  public function get($project, $managedZone, $changeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SmartSEO_Google_Service_Dns_Change");
  }
  /**
   ...
   * @return SmartSEO_Google_Service_Dns_ChangesListResponse
   */
  public function listChanges($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SmartSEO_Google_Service_Dns_ChangesListResponse");
  }
}
 ...
 *  </code>
 */
class SmartSEO_Google_Service_Dns_ManagedZones_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @param string $project
   * Identifies the project addressed by this request.
   * @param SmartSEO_Google_ManagedZone $postBody
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_Dns_ManagedZone
   */
  public function create($project, SmartSEO_Google_Service_Dns_ManagedZone $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "SmartSEO_Google_Service_Dns_ManagedZone");
  }
  /**
  ...
  public function get($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SmartSEO_Google_Service_Dns_ManagedZone");
  }
  /**
   ...
   * Optional. Maximum number of results to be returned. If unspecified, the server will decide how
    * many results to return.
   * @return SmartSEO_Google_Service_Dns_ManagedZonesListResponse
   */
  public function listManagedZones($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SmartSEO_Google_Service_Dns_ManagedZonesListResponse");
  }
}
 ...
 *  </code>
 */
class SmartSEO_Google_Service_Dns_Projects_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * Identifies the project addressed by this request.
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_Dns_Project
   */
  public function get($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SmartSEO_Google_Service_Dns_Project");
  }
}
 ...
 *  </code>
 */
class SmartSEO_Google_Service_Dns_ResourceRecordSets_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * Restricts the list to return only records of this type. If present, the "name" parameter must
    * also be present.
   * @return SmartSEO_Google_Service_Dns_ResourceRecordSetsListResponse
   */
  public function listResourceRecordSets($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SmartSEO_Google_Service_Dns_ResourceRecordSetsListResponse");
  }
}
...
class SmartSEO_Google_Service_Dns_Change extends SmartSEO_Google_Collection
{
  protected $additionsType = 'SmartSEO_Google_Service_Dns_ResourceRecordSet';
  protected $additionsDataType = 'array';
  protected $deletionsType = 'SmartSEO_Google_Service_Dns_ResourceRecordSet';
...
class SmartSEO_Google_Service_Dns_ChangesListResponse extends SmartSEO_Google_Collection
{
  protected $changesType = 'SmartSEO_Google_Service_Dns_Change';
...
class SmartSEO_Google_Service_Dns_ManagedZone extends SmartSEO_Google_Collection
{
  public $creationTime;
  public $description;
  public $dnsName;
...
class SmartSEO_Google_Service_Dns_ManagedZonesListResponse extends SmartSEO_Google_Collection
{
  public $kind;
  protected $managedZonesType = 'SmartSEO_Google_Service_Dns_ManagedZone';
...
class SmartSEO_Google_Service_Dns_Project extends SmartSEO_Google_Model
{
  public $id;
  public $kind;
  public $number;
  protected $quotaType = 'SmartSEO_Google_Service_Dns_Quota';
  ...
  public function setQuota(SmartSEO_Google_Service_Dns_Quota $quota)
  {
    $this->quota = $quota;
  }
...
class SmartSEO_Google_Service_Dns_Quota extends SmartSEO_Google_Model
{
  public $kind;
  public $managedZones;
...
class SmartSEO_Google_Service_Dns_ResourceRecordSet extends SmartSEO_Google_Collection
{
  public $kind;
  public $name;
  public $rrdatas;
...
class SmartSEO_Google_Service_Dns_ResourceRecordSetsListResponse extends SmartSEO_Google_Collection
{
  public $kind;
  public $nextPageToken;
  protected $rrsetsType = 'SmartSEO_Google_Service_Dns_ResourceRecordSet';
