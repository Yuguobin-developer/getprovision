 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_AppState extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->states = new SmartSEO_Google_Service_AppState_States_Resource(
        $this,
        $this->serviceName,
        'states',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appstateService = new SmartSEO_Google_Service_AppState(...);
 *   $states = $appstateService->states;
 *  </code>
 */
class SmartSEO_Google_Service_AppState_States_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @return SmartSEO_Google_Service_AppState_WriteResult
   */
  public function clear($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('clear', array($params), "SmartSEO_Google_Service_AppState_WriteResult");
  }
  /**
   ...
   * The key for the data to be retrieved.
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_AppState_GetResponse
   */
  public function get($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SmartSEO_Google_Service_AppState_GetResponse");
  }
  /**
   ...
   * @return SmartSEO_Google_Service_AppState_ListResponse
   */
  public function listStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SmartSEO_Google_Service_AppState_ListResponse");
  }
  /**
   ...
   * @param int $stateKey
   * The key for the data to be retrieved.
   * @param SmartSEO_Google_UpdateRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return SmartSEO_Google_Service_AppState_WriteResult
   */
  public function update($stateKey, SmartSEO_Google_Service_AppState_UpdateRequest $postBody, $optParams = array())
  {
    $params = array('stateKey' => $stateKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "SmartSEO_Google_Service_AppState_WriteResult");
  }
}
...
class SmartSEO_Google_Service_AppState_GetResponse extends SmartSEO_Google_Model
{
...
class SmartSEO_Google_Service_AppState_ListResponse extends SmartSEO_Google_Collection
{
  protected $itemsType = 'SmartSEO_Google_Service_AppState_GetResponse';
...
class SmartSEO_Google_Service_AppState_UpdateRequest extends SmartSEO_Google_Model
{
  public $data;
  public $kind;
...
class SmartSEO_Google_Service_AppState_WriteResult extends SmartSEO_Google_Model
{
  public $currentStateVersion;
  public $kind;
  public $stateKey;
