 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_Admin extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->mail = new SmartSEO_Google_Service_Admin_Mail_Resource(
        $this,
        $this->serviceName,
        'mail',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new SmartSEO_Google_Service_Admin(...);
 *   $mail = $adminService->mail;
 *  </code>
 */
class SmartSEO_Google_Service_Admin_Mail_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @param SmartSEO_Google_MailItem $postBody
   * @param array $optParams Optional parameters.
   */
  public function insert($userKey, SmartSEO_Google_Service_Admin_MailItem $postBody, $optParams = array())
  {
...
class SmartSEO_Google_Service_Admin_MailItem extends SmartSEO_Google_Collection
{
  public $isDeleted;
  public $isDraft;
  public $isInbox;
