 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_QPXExpress extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->trips = new SmartSEO_Google_Service_QPXExpress_Trips_Resource(
        $this,
        $this->serviceName,
        'trips',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $qpxExpressService = new SmartSEO_Google_Service_QPXExpress(...);
 *   $trips = $qpxExpressService->trips;
 *  </code>
 */
class SmartSEO_Google_Service_QPXExpress_Trips_Resource extends SmartSEO_Google_Service_Resource
{

  /**
   * Returns a list of flights. (trips.search)
   *
   * @param SmartSEO_Google_TripsSearchRequest $postBody
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_QPXExpress_TripsSearchResponse
   */
  public function search(SmartSEO_Google_Service_QPXExpress_TripsSearchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "SmartSEO_Google_Service_QPXExpress_TripsSearchResponse");
  }
}
...
class SmartSEO_Google_Service_QPXExpress_AircraftData extends SmartSEO_Google_Model
{
  public $code;
  public $kind;
  public $name;
...
class SmartSEO_Google_Service_QPXExpress_AirportData extends SmartSEO_Google_Model
{
  public $city;
  public $code;
  public $kind;
...
class SmartSEO_Google_Service_QPXExpress_BagDescriptor extends SmartSEO_Google_Collection
{
...
class SmartSEO_Google_Service_QPXExpress_CarrierData extends SmartSEO_Google_Model
{
  public $code;
  public $kind;
  public $name;
...
class SmartSEO_Google_Service_QPXExpress_CityData extends SmartSEO_Google_Model
{
  public $code;
  public $country;
  public $kind;
...
class SmartSEO_Google_Service_QPXExpress_Data extends SmartSEO_Google_Collection
{
  protected $aircraftType = 'SmartSEO_Google_Service_QPXExpress_AircraftData';
  protected $aircraftDataType = 'array';
  protected $airportType = 'SmartSEO_Google_Service_QPXExpress_AirportData';
  protected $airportDataType = 'array';
  protected $carrierType = 'SmartSEO_Google_Service_QPXExpress_CarrierData';
  protected $carrierDataType = 'array';
  protected $cityType = 'SmartSEO_Google_Service_QPXExpress_CityData';
  protected $cityDataType = 'array';
  public $kind;
  protected $taxType = 'SmartSEO_Google_Service_QPXExpress_TaxData';
...
class SmartSEO_Google_Service_QPXExpress_FareInfo extends SmartSEO_Google_Model
{
  public $basisCode;
  public $carrier;
  public $destination;
...
class SmartSEO_Google_Service_QPXExpress_FlightInfo extends SmartSEO_Google_Model
{
  public $carrier;
  public $number;
...
class SmartSEO_Google_Service_QPXExpress_FreeBaggageAllowance extends SmartSEO_Google_Collection
{
  protected $bagDescriptorType = 'SmartSEO_Google_Service_QPXExpress_BagDescriptor';
...
class SmartSEO_Google_Service_QPXExpress_LegInfo extends SmartSEO_Google_Model
{
  public $aircraft;
  public $arrivalTime;
  public $changePlane;
...
class SmartSEO_Google_Service_QPXExpress_PassengerCounts extends SmartSEO_Google_Model
{
  public $adultCount;
  public $childCount;
...
class SmartSEO_Google_Service_QPXExpress_PricingInfo extends SmartSEO_Google_Collection
{
  public $baseFareTotal;
  protected $fareType = 'SmartSEO_Google_Service_QPXExpress_FareInfo';
  protected $fareDataType = 'array';
  public $fareCalculation;
  public $kind;
  public $latestTicketingTime;
  protected $passengersType = 'SmartSEO_Google_Service_QPXExpress_PassengerCounts';
  ...
  public $saleTaxTotal;
  public $saleTotal;
  protected $segmentPricingType = 'SmartSEO_Google_Service_QPXExpress_SegmentPricing';
  protected $segmentPricingDataType = 'array';
  protected $taxType = 'SmartSEO_Google_Service_QPXExpress_TaxInfo';
  protected $taxDataType = 'array';
  ...
  public function setPassengers(SmartSEO_Google_Service_QPXExpress_PassengerCounts $passengers)
  {
...
class SmartSEO_Google_Service_QPXExpress_SegmentInfo extends SmartSEO_Google_Collection
{
  public $bookingCode;
  ...
  public $connectionDuration;
  public $duration;
  protected $flightType = 'SmartSEO_Google_Service_QPXExpress_FlightInfo';
  protected $flightDataType = '';
  public $id;
  public $kind;
  protected $legType = 'SmartSEO_Google_Service_QPXExpress_LegInfo';
  ...
  public function setFlight(SmartSEO_Google_Service_QPXExpress_FlightInfo $flight)
  {
    $this->flight = $flight;
  }
...
class SmartSEO_Google_Service_QPXExpress_SegmentPricing extends SmartSEO_Google_Collection
{
  public $fareId;
  protected $freeBaggageOptionType = 'SmartSEO_Google_Service_QPXExpress_FreeBaggageAllowance';
...
class SmartSEO_Google_Service_QPXExpress_SliceInfo extends SmartSEO_Google_Collection
{
  public $duration;
  public $kind;
  protected $segmentType = 'SmartSEO_Google_Service_QPXExpress_SegmentInfo';
...
class SmartSEO_Google_Service_QPXExpress_SliceInput extends SmartSEO_Google_Collection
{
  public $alliance;
  public $date;
  public $destination;
  ...
  protected $permittedDepartureTimeType = 'SmartSEO_Google_Service_QPXExpress_TimeOfDayRange';
  ...
  public function setPermittedDepartureTime(SmartSEO_Google_Service_QPXExpress_TimeOfDayRange $permittedDepartureTime)
  {
...
class SmartSEO_Google_Service_QPXExpress_TaxData extends SmartSEO_Google_Model
{
  public $id;
  public $kind;
  public $name;
...
class SmartSEO_Google_Service_QPXExpress_TaxInfo extends SmartSEO_Google_Model
{
  public $chargeType;
  public $code;
  public $country;
...
class SmartSEO_Google_Service_QPXExpress_TimeOfDayRange extends SmartSEO_Google_Model
{
  public $earliestTime;
  public $kind;
  public $latestTime;
...
class SmartSEO_Google_Service_QPXExpress_TripOption extends SmartSEO_Google_Collection
{
  public $id;
  public $kind;
  protected $pricingType = 'SmartSEO_Google_Service_QPXExpress_PricingInfo';
  protected $pricingDataType = 'array';
  public $saleTotal;
  protected $sliceType = 'SmartSEO_Google_Service_QPXExpress_SliceInfo';
...
class SmartSEO_Google_Service_QPXExpress_TripOptionsRequest extends SmartSEO_Google_Collection
{
  public $maxPrice;
  protected $passengersType = 'SmartSEO_Google_Service_QPXExpress_PassengerCounts';
  protected $passengersDataType = '';
  public $refundable;
  public $saleCountry;
  protected $sliceType = 'SmartSEO_Google_Service_QPXExpress_SliceInput';
  protected $sliceDataType = 'array';
  public $solutions;
...
class SmartSEO_Google_Service_QPXExpress_TripOptionsResponse extends SmartSEO_Google_Collection
{
  protected $dataType = 'SmartSEO_Google_Service_QPXExpress_Data';
  protected $dataDataType = '';
  public $kind;
  public $requestId;
  protected $tripOptionType = 'SmartSEO_Google_Service_QPXExpress_TripOption';
  protected $tripOptionDataType = 'array';

  public function setData(SmartSEO_Google_Service_QPXExpress_Data $data)
  {
    $this->data = $data;
  }
...
class SmartSEO_Google_Service_QPXExpress_TripsSearchRequest extends SmartSEO_Google_Model
{
  protected $requestType = 'SmartSEO_Google_Service_QPXExpress_TripOptionsRequest';
  protected $requestDataType = '';

  public function setRequest(SmartSEO_Google_Service_QPXExpress_TripOptionsRequest $request)
  {
...
class SmartSEO_Google_Service_QPXExpress_TripsSearchResponse extends SmartSEO_Google_Model
{
  public $kind;
  protected $tripsType = 'SmartSEO_Google_Service_QPXExpress_TripOptionsResponse';
  ...
  public function setTrips(SmartSEO_Google_Service_QPXExpress_TripOptionsResponse $trips)
  {
    $this->trips = $trips;
  }
