 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_Freebase extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->base_methods = new SmartSEO_Google_Service_Resource(
        $this,
        $this->serviceName,
        '',
        array(
   ...
   * @return SmartSEO_Google_Service_Freebase_ReconcileGet
   */
  public function reconcile($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('reconcile', array($params), "SmartSEO_Google_Service_Freebase_ReconcileGet");
  }
  /**
...
class SmartSEO_Google_Service_Freebase_ReconcileCandidate extends SmartSEO_Google_Model
{
  public $confidence;
  public $lang;
  public $mid;
  public $name;
  protected $notableType = 'SmartSEO_Google_Service_Freebase_ReconcileCandidateNotable';
  ...
  public function setNotable(SmartSEO_Google_Service_Freebase_ReconcileCandidateNotable $notable)
  {
...
class SmartSEO_Google_Service_Freebase_ReconcileCandidateNotable extends SmartSEO_Google_Model
{
  public $id;
  public $name;
...
class SmartSEO_Google_Service_Freebase_ReconcileGet extends SmartSEO_Google_Collection
{
  protected $candidateType = 'SmartSEO_Google_Service_Freebase_ReconcileCandidate';
  protected $candidateDataType = 'array';
  protected $costsType = 'SmartSEO_Google_Service_Freebase_ReconcileGetCosts';
  protected $costsDataType = '';
  protected $matchType = 'SmartSEO_Google_Service_Freebase_ReconcileCandidate';
  protected $matchDataType = '';
  protected $warningType = 'SmartSEO_Google_Service_Freebase_ReconcileGetWarning';
  ...
  public function setCosts(SmartSEO_Google_Service_Freebase_ReconcileGetCosts $costs)
  {
    $this->costs = $costs;
  }
  ...
  public function setMatch(SmartSEO_Google_Service_Freebase_ReconcileCandidate $match)
  {
    $this->match = $match;
  }
...
class SmartSEO_Google_Service_Freebase_ReconcileGetCosts extends SmartSEO_Google_Model
{
  public $hits;
  public $ms;
...
class SmartSEO_Google_Service_Freebase_ReconcileGetWarning extends SmartSEO_Google_Model
{
  public $location;
  public $message;
  public $reason;
