 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_GamesManagement extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->achievements = new SmartSEO_Google_Service_GamesManagement_Achievements_Resource(
        $this,
        $this->serviceName,
        'achievements',
        array(
    ...
    $this->applications = new SmartSEO_Google_Service_GamesManagement_Applications_Resource(
        $this,
        $this->serviceName,
        'applications',
        array(
    ...
    $this->events = new SmartSEO_Google_Service_GamesManagement_Events_Resource(
        $this,
        $this->serviceName,
        'events',
        array(
    ...
    $this->players = new SmartSEO_Google_Service_GamesManagement_Players_Resource(
        $this,
        $this->serviceName,
        'players',
        array(
    ...
    $this->quests = new SmartSEO_Google_Service_GamesManagement_Quests_Resource(
        $this,
        $this->serviceName,
        'quests',
        array(
    ...
    $this->rooms = new SmartSEO_Google_Service_GamesManagement_Rooms_Resource(
        $this,
        $this->serviceName,
        'rooms',
        array(
    ...
    $this->scores = new SmartSEO_Google_Service_GamesManagement_Scores_Resource(
        $this,
        $this->serviceName,
        'scores',
        array(
    ...
    $this->turnBasedMatches = new SmartSEO_Google_Service_GamesManagement_TurnBasedMatches_Resource(
        $this,
        $this->serviceName,
        'turnBasedMatches',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $gamesManagementService = new SmartSEO_Google_Service_GamesManagement(...);
 *   $achievements = $gamesManagementService->achievements;
 *  </code>
 */
class SmartSEO_Google_Service_GamesManagement_Achievements_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @return SmartSEO_Google_Service_GamesManagement_AchievementResetResponse
   */
  public function reset($achievementId, $optParams = array())
  {
    $params = array('achievementId' => $achievementId);
    $params = array_merge($params, $optParams);
    return $this->call('reset', array($params), "SmartSEO_Google_Service_GamesManagement_AchievementResetResponse");
  }
  /**
   ...
   *
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_GamesManagement_AchievementResetAllResponse
   */
  public function resetAll($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('resetAll', array($params), "SmartSEO_Google_Service_GamesManagement_AchievementResetAllResponse");
  }
  /**
 ...
 *  </code>
 */
class SmartSEO_Google_Service_GamesManagement_Applications_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * The maximum number of player resources to return in the response, used for paging. For any
    ...
    * maxResults.
   * @return SmartSEO_Google_Service_GamesManagement_HiddenPlayerList
   */
  public function listHidden($applicationId, $optParams = array())
  {
    $params = array('applicationId' => $applicationId);
    $params = array_merge($params, $optParams);
    return $this->call('listHidden', array($params), "SmartSEO_Google_Service_GamesManagement_HiddenPlayerList");
  }
}
 ...
 *  </code>
 */
class SmartSEO_Google_Service_GamesManagement_Events_Resource extends SmartSEO_Google_Service_Resource
{
 ...
 *  </code>
 */
class SmartSEO_Google_Service_GamesManagement_Players_Resource extends SmartSEO_Google_Service_Resource
{
 ...
 *  </code>
 */
class SmartSEO_Google_Service_GamesManagement_Quests_Resource extends SmartSEO_Google_Service_Resource
{
 ...
 *  </code>
 */
class SmartSEO_Google_Service_GamesManagement_Rooms_Resource extends SmartSEO_Google_Service_Resource
{
 ...
 *  </code>
 */
class SmartSEO_Google_Service_GamesManagement_Scores_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_GamesManagement_PlayerScoreResetResponse
   */
  public function reset($leaderboardId, $optParams = array())
  {
    $params = array('leaderboardId' => $leaderboardId);
    $params = array_merge($params, $optParams);
    return $this->call('reset', array($params), "SmartSEO_Google_Service_GamesManagement_PlayerScoreResetResponse");
  }
  /**
 ...
 *  </code>
 */
class SmartSEO_Google_Service_GamesManagement_TurnBasedMatches_Resource extends SmartSEO_Google_Service_Resource
{
...
class SmartSEO_Google_Service_GamesManagement_AchievementResetAllResponse extends SmartSEO_Google_Collection
{
  public $kind;
  protected $resultsType = 'SmartSEO_Google_Service_GamesManagement_AchievementResetResponse';
...
class SmartSEO_Google_Service_GamesManagement_AchievementResetResponse extends SmartSEO_Google_Model
{
  public $currentState;
  public $definitionId;
  public $kind;
...
class SmartSEO_Google_Service_GamesManagement_GamesPlayedResource extends SmartSEO_Google_Model
{
  public $autoMatched;
  public $timeMillis;
...
class SmartSEO_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource extends SmartSEO_Google_Model
{
  public $currentExperiencePoints;
  protected $currentLevelType = 'SmartSEO_Google_Service_GamesManagement_GamesPlayerLevelResource';
  protected $currentLevelDataType = '';
  public $lastLevelUpTimestampMillis;
  protected $nextLevelType = 'SmartSEO_Google_Service_GamesManagement_GamesPlayerLevelResource';
  ...
  public function setCurrentLevel(SmartSEO_Google_Service_GamesManagement_GamesPlayerLevelResource $currentLevel)
  {
  ...
  public function setNextLevel(SmartSEO_Google_Service_GamesManagement_GamesPlayerLevelResource $nextLevel)
  {
...
class SmartSEO_Google_Service_GamesManagement_GamesPlayerLevelResource extends SmartSEO_Google_Model
{
  public $level;
...
class SmartSEO_Google_Service_GamesManagement_HiddenPlayer extends SmartSEO_Google_Model
{
  public $hiddenTimeMillis;
  public $kind;
  protected $playerType = 'SmartSEO_Google_Service_GamesManagement_Player';
  ...
  public function setPlayer(SmartSEO_Google_Service_GamesManagement_Player $player)
  {
    $this->player = $player;
  }
...
class SmartSEO_Google_Service_GamesManagement_HiddenPlayerList extends SmartSEO_Google_Collection
{
  protected $itemsType = 'SmartSEO_Google_Service_GamesManagement_HiddenPlayer';
...
class SmartSEO_Google_Service_GamesManagement_Player extends SmartSEO_Google_Model
{
  public $avatarImageUrl;
  public $displayName;
  protected $experienceInfoType = 'SmartSEO_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource';
  protected $experienceInfoDataType = '';
  public $kind;
  protected $lastPlayedWithType = 'SmartSEO_Google_Service_GamesManagement_GamesPlayedResource';
  protected $lastPlayedWithDataType = '';
  protected $nameType = 'SmartSEO_Google_Service_GamesManagement_PlayerName';
  ...
  public function setExperienceInfo(SmartSEO_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource $experienceInfo)
  {
  ...
  public function setLastPlayedWith(SmartSEO_Google_Service_GamesManagement_GamesPlayedResource $lastPlayedWith)
  {
  ...
  public function setName(SmartSEO_Google_Service_GamesManagement_PlayerName $name)
  {
    $this->name = $name;
  }
...
class SmartSEO_Google_Service_GamesManagement_PlayerName extends SmartSEO_Google_Model
{
  public $familyName;
  public $givenName;
...
class SmartSEO_Google_Service_GamesManagement_PlayerScoreResetResponse extends SmartSEO_Google_Collection
{
  public $kind;
