 ...
 * @author Google, Inc.
 */
class SmartSEO_Google_Service_YouTubeAnalytics extends SmartSEO_Google_Service
{
  ...
  public function __construct(SmartSEO_Google_Client $client)
  {
    ...
    $this->batchReportDefinitions = new SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource(
        $this,
        $this->serviceName,
    ...
    $this->batchReports = new SmartSEO_Google_Service_YouTubeAnalytics_BatchReports_Resource(
        $this,
        $this->serviceName,
        'batchReports',
        array(
    ...
    $this->reports = new SmartSEO_Google_Service_YouTubeAnalytics_Reports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $youtubeAnalyticsService = new SmartSEO_Google_Service_YouTubeAnalytics(...);
 *   $batchReportDefinitions = $youtubeAnalyticsService->batchReportDefinitions;
 *  </code>
 */
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @return SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitionList
   */
  public function listBatchReportDefinitions($onBehalfOfContentOwner, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitionList");
  }
}
 ...
 *  </code>
 */
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReports_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of.
   * @param array $optParams Optional parameters.
   * @return SmartSEO_Google_Service_YouTubeAnalytics_BatchReportList
   */
  public function listBatchReports($batchReportDefinitionId, $onBehalfOfContentOwner, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SmartSEO_Google_Service_YouTubeAnalytics_BatchReportList");
  }
}
 ...
 *  </code>
 */
class SmartSEO_Google_Service_YouTubeAnalytics_Reports_Resource extends SmartSEO_Google_Service_Resource
{
   ...
   * @return SmartSEO_Google_Service_YouTubeAnalytics_ResultTable
   */
  public function query($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "SmartSEO_Google_Service_YouTubeAnalytics_ResultTable");
  }
}
...
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitionList extends SmartSEO_Google_Collection
{
  protected $itemsType = 'SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplate';
...
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplate extends SmartSEO_Google_Collection
{
  protected $defaultOutputType = 'SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplateDefaultOutput';
...
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplateDefaultOutput extends SmartSEO_Google_Model
{
  public $format;
  public $type;
...
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReportList extends SmartSEO_Google_Collection
{
  protected $itemsType = 'SmartSEO_Google_Service_YouTubeAnalytics_BatchReportTemplate';
  protected $itemsDataType = 'array';
  public $kind;
...
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReportTemplate extends SmartSEO_Google_Collection
{
  public $id;
  protected $outputsType = 'SmartSEO_Google_Service_YouTubeAnalytics_BatchReportTemplateOutputs';
  protected $outputsDataType = 'array';
  public $reportId;
  protected $timeSpanType = 'SmartSEO_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan';
  ...
  public function setTimeSpan(SmartSEO_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan $timeSpan)
  {
...
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReportTemplateOutputs extends SmartSEO_Google_Model
{
  public $downloadUrl;
  public $format;
  public $type;
...
class SmartSEO_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan extends SmartSEO_Google_Model
{
  public $endTime;
  public $startTime;
...
class SmartSEO_Google_Service_YouTubeAnalytics_ResultTable extends SmartSEO_Google_Collection
{
  protected $columnHeadersType = 'SmartSEO_Google_Service_YouTubeAnalytics_ResultTableColumnHeaders';
...
class SmartSEO_Google_Service_YouTubeAnalytics_ResultTableColumnHeaders extends SmartSEO_Google_Model
{
  public $columnType;
  public $dataType;
  public $name;
