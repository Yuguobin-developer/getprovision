	...
	return (
		<Fragment>
			<InspectorControls>
				...
				<PanelBody title={ __( 'Container Style' ) } initialOpen={ false }>
					<div className="section-bg-settings">
						<SelectControl
							label="Style"
							value={ bgName }
							options={ [
								{ label: 'No Wrapper Style', value: 'noBgStyle' },
								{ label: 'Medium Small  Wrapper', value: 'ms-section' },
								{ label: 'Small  Wrapper', value: 's-section' },
								{ label: 'Full Width Green Wrapper', value: 'midpage-cta' },
								{ label: 'Light Green Wrapper', value: 'green-container' },
								{ label: 'Small Hexagon Wrapper', value: 'energy-choice-block s-section' },
							] }
							onChange={ ( bgName ) => {
								setAttributes( { bgName } );
							} }
						/>
					</div>
				</PanelBody>
			...
			>
				{ !! bgImage && (
					<div
						className={ classnames( 'section-bg', {
